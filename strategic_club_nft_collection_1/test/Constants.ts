...
export const TOKEN_NAME: string = "Strategic Club NFT Collection #1";
export const TOKEN_SYMBOL: string = "SCN1";
export const TOKEN_DEF_WALLET_MAX_TOKENS: BigNumber = UINT256_MAX;
...
export const TOKEN_INITIAL_UNREVEALED_URI: string = TOKEN_INITIAL_BASE_URI + "unrevealed";
