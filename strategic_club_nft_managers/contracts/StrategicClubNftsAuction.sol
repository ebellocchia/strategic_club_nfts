 ...
 * @title  Strategic Club NFTs auction
 ...
 */
contract StrategicClubNftsAuction is
    ReentrancyGuard,
    TelegramNftsManager
{
    //=============================================================//
        ...
        notNullAddress(nftContract_)
    {
        ...
        if (auction.nftAmount == 0) {
            _revertIfTelegramIdERC721FlagIsSet(telegramId_, IERC721(nftContract_));
        }
        else {
            _revertIfTelegramIdERC1155FlagIsSet(telegramId_, IERC1155(nftContract_), nftId_);
        }
        if (!__isAuctionActive(auction)) {
            revert AuctionNotActiveError(nftContract_, nftId_);
        }
